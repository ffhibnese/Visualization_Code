...
dataset_label = ['GoogleNet', 'Inc-v4', 'Inc-Res-v2']
scale_label = ['0.5', '0.75', '0.9', '1.2', '1.4', '1.6']

# cgsp = [48.04, 36.09, 20.02]
# cgnc = [63.75, 41.63, 37.70]

cgsp = [0.3271, 0.4453, 0.2664]
cgnc = [0.4356, 0.5527, 0.3784]
...
if __name__ == '__main__':
    ...
    plt.ylabel('Confidence score', fontproperties=legend_font4)
    # plt.xlabel('Targeted model', fontproperties=legend_font4, color='black')
    x = np.array([4, 10, 16])
    
    plt.grid(zorder=0, alpha=0.3)
    plt.xticks(x, dataset_label, font=legend_font_x_tick)
    plt.yticks(np.linspace(0.2, 0.6, 5), font=legend_font4)
    plt.ylim(ymin = 0.2, ymax=0.64)
    ...
    plt.bar(x + width, cgnc, width=width, label="CGNC", color='firebrick', alpha=1, zorder=10)
    ...
    plt.savefig('./imgs/bar_motivation.png', dpi=400, bbox_inches='tight')
