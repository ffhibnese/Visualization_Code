...
# class_id = ['62', '715', '150']
res152_class_id = ['43', '174', '868']
# incv3_class_id = ['62', '150', '952']


random = [69.375, 77.25, 78.5]
avg = [96.625, 83.375, 5.375]
Badrdm = [100, 99.75, 84.5]
...
if __name__ == '__main__':
    ...
    plt.yticks((10, 30, 50, 70, 90), font=legend_font4)
    ...
    plt.bar(x + width, random, width=width, label='Random', color='lightblue', alpha=0.95, zorder=10)
    ...
    plt.savefig('../imgs/badrdm_tse_bar.pdf', dpi=400, bbox_inches='tight')
