...
# class_id = ['62', '715', '150']
lambda_vals = ['0', '0.5', '1.0', '1.5', '2.0']
# incv3_class_id = ['62', '150', '952']


varying_lambda = [33.0, 31.6, 30.2, 31.0, 31.8]
...
if __name__ == '__main__':
    ...
    plt.xlabel('$\\alpha$ values $(\\times 100)$', fontproperties=legend_font2)
    ...
    plt.yticks((29, 30, 31, 32, 33), font=legend_font4)
    plt.ylim(ymin = 29, ymax=33.3)
    ...
    plt.bar(x + width/2, varying_lambda, width=width, label='Random', color='#9467bd', alpha=0.99, zorder=10)
    ...
    plt.savefig('../imgs/CMI_VLD_alpha_bar.png', dpi=400, bbox_inches='tight')
