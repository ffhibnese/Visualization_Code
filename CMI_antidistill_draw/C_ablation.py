...
# ---------- 数据 ----------
_3B_ori = [72.02426,	72.17589,	71.64519,	71.49356,	70.88704]
_1_5B_ori = [62.31994,	62.69901,	58.52919,	59.21152,	59.51478]
_0_5B_ori = [40.18196,	38.66566,	35.93632,	36.16376,	35.48143]
teacher = [80.13647,	81.50113723,	79.83321,	78.77179682,	76.6489765] 
d = [1, 2, 3, 4, 5]

fig, (ax_top, ax_mid, ax_bottom, ax_teacher) = plt.subplots(
    4, 1, sharex=True, figsize=(5, 6),
    gridspec_kw={'height_ratios': [5, 6, 6, 8]}   
)
# ---------- 绘图 ----------
dot_size = 8
line_width = 2.5
for ax in (ax_top, ax_mid, ax_bottom):
#     ax.plot(d, teacher, '+-', markersize=dot_size, color='black',
        #     linewidth=line_width, alpha=1, label='Teacher w/ Defense')
    # ax.plot(d, _3B_ori, 'o-', markersize=dot_size, color=(255/255, 0/255, 0/255),
    #         linewidth=line_width, alpha=1, label='3B')
    # ax.plot(d, _1_5B_ori, 'o-', markersize=dot_size, color=(46/255, 139/255, 87/255),
    #         linewidth=line_width, alpha=1, label='1.5B')
    # ax.plot(d, _0_5B_ori, 'o-', markersize=dot_size, color=(237/255, 130/255, 237/255),
    ...
    ax.plot(d, _0_5B_ori, 'o-', markersize=dot_size, color=(193/255, 223/255, 175/255),
            linewidth=line_width, alpha=1, label='0.5B')  # (247/255, 147/255, 139/255) (226/255, 240/255, 217/255)

# ax_teacher.bar(d, teacher, width=0.4,        # 柱宽按需调
#                color=(67/255, 106/255, 225/255), alpha=1,
#                label='Teacher')
ax_teacher.bar(d, teacher, width=0.4,        # 柱宽按需调
...
ax_top.set_ylim(70.5, 72.5)
ax_mid.set_ylim(58, 63.5)
ax_bottom.set_ylim(35, 41)
ax_teacher.set_ylim(76, 82)

ax_top.set_yticks([71, 72])   # 57 59 61 ... 83
ax_mid.set_yticks([59, 62])
ax_bottom.set_yticks([36, 39])  # 34 36 38
ax_teacher.set_yticks([77, 79, 81])

ax_top.set_yticklabels([71, 72], fontproperties=legend_font4)
ax_mid.set_yticklabels([59, 62], fontproperties=legend_font4)
ax_bottom.set_yticklabels([36, 39], fontproperties=legend_font4)
ax_teacher.set_yticklabels([77, 79, 81], fontproperties=legend_font4)

ax_teacher.set_xticks(d)
ax_teacher.set_xticklabels([8, 16, 32, 48, 64], fontproperties=legend_font4)

# ---------- 3. 整张图统一 y 标签 ----------
fig.supylabel('Accuracy (%)', fontproperties=legend_font2, color='black', x=0.02, y=0.6)

# ---------- 标签 ----------
ax_teacher.set_xlabel(r'$r$', fontproperties=legend_font3, color='black')
...
plt.savefig('./pic/C_ablation.pdf', dpi=400, bbox_inches='tight')
plt.show()