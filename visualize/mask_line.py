...
plt.ylabel('Fooling rate', fontproperties=legend_font2, color='black')
...
# x = ['10', '10+5', '10+5mask']
# class_150 = [72.1000, 73.6333, 78.3833]
# class_426 = [46.0167, 56.4333, 63.3167]
# class_843 = [60.0833, 71.5667, 76.1167]
# class_715 = [50.9667, 45.7833, 56.4667]
# class_952 = [60.6333, 70.8167, 78.4000]
# class_507 = [54.7833, 59.2500, 64.1833]
# class_590 = [47.0333, 45.9667, 49.6500]
# class_62 = [75.5833, 75.4333, 84.2000]
class_id = ['150', '426', '843', '715', '952', '507', '590', '62']
class_id = ['62', '150', '426', '507', '590', '715', '843', '952']
epoch10 = [75.5833, 72.1000, 46.0167, 54.7833, 47.0333, 50.9667, 60.0833, 60.6333]
epoch15 = [75.4333, 73.6333, 56.4333, 59.2500, 45.9667, 45.7833, 71.5667, 70.8167]
mask = [84.2000, 78.3833, 63.3167, 64.1833, 49.6500, 56.4667, 76.1167, 78.4000]


dot_size = 8
line_width = 2.5
p1,=plt.plot(class_id, epoch10, 'o-',markersize=dot_size, color='orange', linewidth=line_width, alpha=1, label='10 epoch')
p2,=plt.plot(class_id, epoch15, 'o-',markersize=dot_size, color='lightskyblue', linewidth=line_width, alpha=1, label='15 epoch')
p3,=plt.plot(class_id, mask, 'o-',markersize=dot_size, color='darkblue', linewidth=line_width, alpha=1, label='mask')
...
plt.legend((p1, p2, p3), ('CGNC', 'Fine-tuning (no mask)', 'Mask fine-tuning'), ncol=1, frameon=False, prop=legend_font, loc='best', bbox_to_anchor=(1.02,0.32))
...
plt.xticks(font=legend_font4)
plt.yticks((40, 50, 60, 70, 80, 90), font=legend_font4)
...
plt.savefig('../imgs/mask_line.pdf', dpi=400, bbox_inches='tight')
plt.show()